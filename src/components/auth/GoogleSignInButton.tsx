    ...
    <div className={`relative ${className}`}>
      ...
      {!isAvailable && !isLoading && (
        ...
        >
          ...
          {text === 'signin_with' ? 'Đăng nhập với Google' :
           text === 'signup_with' ? 'Đăng ký với Google' :
